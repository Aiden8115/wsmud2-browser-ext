...
(function () {
    ...
    (function () {
        const executor = new UntilSearchedAtCmdExecutor("events", (regex, from) => {
            return EventList.search(regex, from);
        });
        CmdExecuteCenter.addExecutor(executor);
    })();
    (function () {
...
`
    ...
    function createRaidEditor(textareaId, options) {
        ...
        textarea.addEventListener('keydown', function (e) {
            ...
            // --- Tab: indent or apply autocomplete ---
            if (key === 'Tab') {
                e.preventDefault();
                var start = textarea.selectionStart;
                var end = textarea.selectionEnd;
