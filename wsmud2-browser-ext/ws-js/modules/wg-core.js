      ...
      login: function () {
          ...
          if (backimageurl != '') {
              var backcss = `.loading {
                  ...
                  -webkit-backdrop-filter: blur(3px); /* 50% 透明度 */
              }
              ...
              .tool-bar > .tool-item {
                  background-color: rgba(128, 128, 128, 1); /* 50% 透明度 */
              }

              .tool-bar > .tool-item:hover {
                  background-color: rgba(102, 102, 102, 1); /* 50% 透明度 */
              }
              ...
              .item-commands > span {
                  background-color: rgba(0, 0, 0, 0.3); /* 50% 透明度 */
              }

              .warn-dialog {
                  background: rgba(17, 17, 17, 0.5); /* 50% 透明度 */
              }
              ...
              .dialog-titles > .title-item > .btn-noused {
                  ...
                  backdrop-filter: blur(3px);
                  -webkit-backdrop-filter: blur(3px); /* 50% 透明度 */
                  border-left: 1px solid rgba(18, 18, 18, 0.5); /* 50% 透明度 */
              }
              ...
              .extend-row {
                  ...
                  backdrop-filter: blur(3px);
                  -webkit-backdrop-filter: blur(3px); /* 50% 透明度 */
                  border-top: 1px solid rgba(34, 34, 34, 0.5); /* 50% 透明度 */
                  border-bottom: 1px solid rgba(34, 34, 34, 0.5); /* 50% 透明度 */
              }
              ...
              .switch {
                  background: rgba(34, 34, 34, 0.5); /* 50% 透明度 */
              }
              ...
              .dialog-relation > .relation-item > .relation-cmd {
                  ...
                  backdrop-filter: blur(3px);
                  -webkit-backdrop-filter: blur(3px); /* 50% 透明度 */
                  border-left: 2px solid rgba(17, 17, 17, 0.5); /* 50% 透明度 */
              }
              ...
              /*
              *  为整个房间描述容器 (div.room_desc) 添加高斯模糊背景效果
              */
              div.room_desc,
              div.room_title {
